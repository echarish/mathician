...
class GridItemView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if ((horizontalLine / 2 - 1) <= index && (horizontalLine / 2 + 1) > index) {
      // print('horizontalLine $horizontalLine & index $index');
      // print((horizontalLine / 2 - 1) <= index);
      // print((horizontalLine / 2 + 1) > index);
      ...
      int tempIndex = ((horizontalLine / 2 - 1) <= index && (horizontalLine / 2 + 1) > index) ? index - 2 : index;
      return SizedBox(
        height: verticalLine,
        child: Row(
          children: [
...
var list2 = [
  [Tuple2("+", 0), Tuple2("0", 0), Tuple2("8", 0), Tuple2("1", 0), Tuple2("7", 0), Tuple2("*", 0)],
  [
    Tuple2("3", 0),
    Tuple2("%", 0),
    Tuple2("5", 0),
