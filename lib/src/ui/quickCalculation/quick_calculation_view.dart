  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          appBar: CommonAppBar<QuickCalculationProvider>(colorTuple: colorTuple),
          body: SafeArea(
            bottom: true,
            child: DialogListener<QuickCalculationProvider>(
              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    CommonInfoTextView<QuickCalculationProvider>(gameCategoryType: GameCategoryType.QUICK_CALCULATION),
                    Expanded(
                      flex: 3,
                      child: Column(
                        ...
                        children: [
                          Text(
                            "NEXT",
                            style: Theme.of(context).textTheme.caption!.copyWith(fontSize: ViewUtils().getViewSize(18)),
                          ),
                          Row(
                            children: [
                              Expanded(
                                child: Selector<QuickCalculationProvider, Tuple3<QuickCalculation, QuickCalculation, QuickCalculation?>>(
                                  selector: (p0, p1) => Tuple3(p1.currentState, p1.nextCurrentState, p1.previousCurrentState),
                              ...
                              SizedBox(width: 6),
                              Selector<QuickCalculationProvider, Tuple2<double, double>>(
                                      ...
                                      builder: (context, result, child) {
                                        return Text(result,
                                            style: Theme.of(context)
                                                .textTheme
                                                .subtitle2!
                                                .copyWith(fontSize: ViewUtils().getViewSize(24), color: colorTuple.item1));
                                      }),
                                ),
                              ),
                            ],
                    ...
                    Expanded(
                      ...
                      child: LayoutBuilder(builder: (context, constraints) {
                        var aspectRatio = (constraints.maxWidth / 3) / ((constraints.maxHeight - 24) / 4);
                        return GridView(
                              ...
                              (e) {
                                if (e == "Clear") {
                                  return CommonClearButton(
                                      text: "Clear",
                                      onTab: () {
                                        context.read<QuickCalculationProvider>().clearResult();
                                      });
                                } else if (e == "Back") {
                                  return CommonBackButton(onTab: () {
                                    context.read<QuickCalculationProvider>().backPress();
                                  });
                                } else {
                                  return CommonNumberButton(
                                    text: e,
                                    onTab: () {
                                      context.read<QuickCalculationProvider>().checkResult(e);
                                    },
