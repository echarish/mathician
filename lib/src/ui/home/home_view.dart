...
class _HomeViewState extends State<HomeView> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    animationController = AnimationController(vsync: this, duration: Duration(seconds: 0));
    bgColorTween = ColorTween(begin: Colors.black, end: Color(0xFF212121)).animate(
      CurvedAnimation(
    ...
    heightTween = Tween(begin: 183.0 + widget.tuple2.item2, end: 56.0 + widget.tuple2.item2).animate(animationController);
    ...
    outlineImageBottomPositionTween = Tween(begin: 56.0, end: 56.0).animate(animationController);
    outlineImageRightPositionTween = Tween(begin: -40.0, end: -150.0).animate(animationController);
    fillImageBottomPositionTween = Tween(begin: 54.0, end: 136.0).animate(animationController);
    fillImageRightPositionTween = Tween(begin: -54.0, end: -240.0).animate(animationController);
  ...
  bool _scrollListener(ScrollNotification scrollInfo) {
    if (scrollInfo.metrics.axis == Axis.vertical && scrollInfo.metrics.pixels <= 127) {
                ...
                SizedBox(
                  ...
                  child: AnimatedBuilder(
                    ...
                    builder: (context, child) => PhysicalModel(
                      color: Theme.of(context).brightness == Brightness.light ? Theme.of(context).colorScheme.baseColor : bgColorTween.value,
                      elevation: elevationTween.value,
                      borderRadius:
                          BorderRadius.only(bottomLeft: Radius.circular(radiusTween.value), bottomRight: Radius.circular(radiusTween.value)),
                      child: Container(
                            ...
                            Padding(
                              ...
                              child: Card(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    await GoogleAdsHelper.showInterstitialAd();
